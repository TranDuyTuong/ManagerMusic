...
namespace DataMigration.Migrations
{
    ...
    [Migration("20220811035841_ManagerMusicDatabase_V9")]
    partial class ManagerMusicDatabase_V9
    {
            ...
            modelBuilder.Entity("DataTable.Table.Account.T_ActiverAccount", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdAccountActiver = 1,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 332, DateTimeKind.Utc).AddTicks(6124),
                            NameAccountActiver = "Hoạt Động"
                        },
                        new
                        {
                            IdAccountActiver = 2,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 332, DateTimeKind.Utc).AddTicks(6356),
            ...
            modelBuilder.Entity("DataTable.Table.Address.T_City", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdCity = 1,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 328, DateTimeKind.Utc).AddTicks(7547),
                            NameCity = "Thành Phố Hồ Chí Mình"
                        },
                        new
                        {
                            IdCity = 2,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 328, DateTimeKind.Utc).AddTicks(7939),
                            NameCity = "Thủ Đô Hà Nội"
                        },
                        new
                        {
                            IdCity = 3,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 328, DateTimeKind.Utc).AddTicks(7947),
                            NameCity = "Thành Phố Huế"
                        },
                        new
                        {
                            IdCity = 4,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 328, DateTimeKind.Utc).AddTicks(7949),
                            NameCity = "Thành Phố Đã Nẵng"
                        },
                        new
                        {
                            IdCity = 5,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 328, DateTimeKind.Utc).AddTicks(7950),
                            NameCity = "Thành Phố Đà Lạt"
                        },
                        new
                        {
                            IdCity = 6,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 328, DateTimeKind.Utc).AddTicks(7951),
                            NameCity = "Thành Phố Vũng Tàu"
                        },
                        new
                        {
                            IdCity = 7,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 328, DateTimeKind.Utc).AddTicks(7952),
            ...
            modelBuilder.Entity("DataTable.Table.Address.T_District", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdDistrict = 1,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 329, DateTimeKind.Utc).AddTicks(8011),
                            IdCity = 1,
                            NameDistrict = "Quận 1"
                        },
                        new
                        {
                            IdDistrict = 2,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 329, DateTimeKind.Utc).AddTicks(8398),
                            IdCity = 2,
                        ...
                        {
                            IdDistrict = 3,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 329, DateTimeKind.Utc).AddTicks(8402),
                            IdCity = 3,
                        ...
                        {
                            IdDistrict = 4,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 329, DateTimeKind.Utc).AddTicks(8407),
                            IdCity = 4,
                        ...
                        {
                            IdDistrict = 5,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 329, DateTimeKind.Utc).AddTicks(8408),
                            IdCity = 5,
                        ...
                        {
                            IdDistrict = 6,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 329, DateTimeKind.Utc).AddTicks(8410),
                            IdCity = 6,
                        ...
                        {
                            IdDistrict = 7,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 329, DateTimeKind.Utc).AddTicks(8411),
                            IdCity = 7,
            ...
            modelBuilder.Entity("DataTable.Table.Gender.T_Gender", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdGender = 1,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 329, DateTimeKind.Utc).AddTicks(9779),
                            NameGender = "Nam"
                        },
                        new
                        {
                            IdGender = 2,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 330, DateTimeKind.Utc).AddTicks(369),
                            NameGender = "Nữ"
                        },
                        new
                        {
                            IdGender = 3,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 330, DateTimeKind.Utc).AddTicks(374),
            ...
            modelBuilder.Entity("DataTable.Table.Marriage.T_Marriage", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdMarriage = 1,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 330, DateTimeKind.Utc).AddTicks(1585),
                            NameMarriage = "Độc Thân"
                        },
                        new
                        {
                            IdMarriage = 2,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 330, DateTimeKind.Utc).AddTicks(1914),
                            NameMarriage = "Đã Kết Hôn"
                        },
                        new
                        {
                            IdMarriage = 3,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 330, DateTimeKind.Utc).AddTicks(1918),
            ...
            modelBuilder.Entity("DataTable.Table.Music.T_StatusMusic", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdStatusMusic = 1,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 330, DateTimeKind.Utc).AddTicks(3344),
                            NameStatusMusic = "Đang Hoạt Động"
                        },
                        new
                        {
                            IdStatusMusic = 2,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 330, DateTimeKind.Utc).AddTicks(3718),
                            NameStatusMusic = "Ngưng Hoạt Động"
                        },
                        new
                        {
                            IdStatusMusic = 3,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 330, DateTimeKind.Utc).AddTicks(3725),
            ...
            modelBuilder.Entity("DataTable.Table.RequestUser.T_ReadUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdRead = 1,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 330, DateTimeKind.Utc).AddTicks(4994),
                            ReadContent = "Đã Đọc"
                        },
                        new
                        {
                            IdRead = 2,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 330, DateTimeKind.Utc).AddTicks(5573),
            ...
            modelBuilder.Entity("DataTable.Table.RequestUser.T_ReceiveRequest", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdReceiveRequest = 1,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 330, DateTimeKind.Utc).AddTicks(6973),
                            Description = "Chưa Giải Quyết"
                        },
                        new
                        {
                            IdReceiveRequest = 2,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 330, DateTimeKind.Utc).AddTicks(7251),
                            Description = "Đang Giải Quyết"
                        },
                        new
                        {
                            IdReceiveRequest = 3,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 330, DateTimeKind.Utc).AddTicks(7254),
            ...
            modelBuilder.Entity("DataTable.Table.RequestUser.T_TypeSentUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdTypeSent = 1,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 330, DateTimeKind.Utc).AddTicks(8516),
                            NameType = "Gửi Qua Gmail"
                        },
                        new
                        {
                            IdTypeSent = 2,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 330, DateTimeKind.Utc).AddTicks(8757),
            ...
            modelBuilder.Entity("DataTable.Table.Role.T_Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "a37e2a10-60e3-463c-988d-2ea07418e362",
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 331, DateTimeKind.Utc).AddTicks(2635),
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "9e11d3ff-43d3-49dc-8211-207f05696c97",
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 331, DateTimeKind.Utc).AddTicks(2907),
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "b7d85caa-9046-4144-9008-6747f13ed70d",
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 331, DateTimeKind.Utc).AddTicks(2916),
                            Description = "Quản Lý",
            ...
            modelBuilder.Entity("DataTable.Table.Role.T_StatusRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdStatusRole = 1,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 330, DateTimeKind.Utc).AddTicks(9676),
                            NameStatus = "Hoạt Động"
                        },
                        new
                        {
                            IdStatusRole = 2,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 330, DateTimeKind.Utc).AddTicks(9916),
            ...
            modelBuilder.Entity("DataTable.Table.Saints.T_Saints", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdSaints = 1,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 331, DateTimeKind.Utc).AddTicks(5290),
                            IdStatusSaints = 1,
                        ...
                        {
                            IdSaints = 2,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 331, DateTimeKind.Utc).AddTicks(5684),
                            IdStatusSaints = 1,
                        ...
                        {
                            IdSaints = 3,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 331, DateTimeKind.Utc).AddTicks(5687),
                            IdStatusSaints = 1,
                        ...
                        {
                            IdSaints = 4,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 331, DateTimeKind.Utc).AddTicks(5689),
                            IdStatusSaints = 1,
                        ...
                        {
                            IdSaints = 5,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 331, DateTimeKind.Utc).AddTicks(5690),
                            IdStatusSaints = 1,
                        ...
                        {
                            IdSaints = 6,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 331, DateTimeKind.Utc).AddTicks(5691),
                            IdStatusSaints = 1,
            ...
            modelBuilder.Entity("DataTable.Table.Saints.T_StatusSaints", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdIdStatusSaints = 1,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 331, DateTimeKind.Utc).AddTicks(3725),
                            NameStatusSaints = "Hoạt Động"
                        },
                        new
                        {
                            IdIdStatusSaints = 2,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 331, DateTimeKind.Utc).AddTicks(4080),
            ...
            modelBuilder.Entity("DataTable.Table.Season.T_Season", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdSeason = 1,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 331, DateTimeKind.Utc).AddTicks(7803),
                            IdStatusSeason = 1,
                        ...
                        {
                            IdSeason = 2,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 331, DateTimeKind.Utc).AddTicks(8031),
                            IdStatusSeason = 1,
                            NameSeason = "Mùa Vọng"
                        },
                        new
                        {
                            IdSeason = 3,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 331, DateTimeKind.Utc).AddTicks(8034),
                            IdStatusSeason = 1,
                        ...
                        {
                            IdSeason = 4,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 331, DateTimeKind.Utc).AddTicks(8035),
                            IdStatusSeason = 1,
                        ...
                        {
                            IdSeason = 5,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 331, DateTimeKind.Utc).AddTicks(8037),
                            IdStatusSeason = 1,
                            NameSeason = "Mùa Chay"
                        },
                        new
                        {
                            IdSeason = 6,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 331, DateTimeKind.Utc).AddTicks(8038),
                            IdStatusSeason = 1,
            ...
            modelBuilder.Entity("DataTable.Table.Season.T_StatusSeason", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdStatusSeason = 1,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 331, DateTimeKind.Utc).AddTicks(6591),
                            NameStatus = "Hoạt Động"
                        },
                        new
                        {
                            IdStatusSeason = 2,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 331, DateTimeKind.Utc).AddTicks(6825),
                            NameStatus = "Ngưng Hoạt Động"
                        });
                });
            ...
            modelBuilder.Entity("DataTable.Table.Staff.T_StatusHappyBirthDayStaff", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IsStatusSent = 1,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 331, DateTimeKind.Utc).AddTicks(8801),
                            Description = "Gửi Thành Công"
                        },
                        new
                        {
                            IsStatusSent = 2,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 331, DateTimeKind.Utc).AddTicks(9124),
            ...
            modelBuilder.Entity("DataTable.Table.Staff.T_StatusStaffOff", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            StatusStaffOff = 1,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 331, DateTimeKind.Utc).AddTicks(9936),
                            Description = "Còn Làm"
                        },
                        new
                        {
                            StatusStaffOff = 2,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 332, DateTimeKind.Utc).AddTicks(168),
            ...
            modelBuilder.Entity("DataTable.Table.User.T_DeleteNotification", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 332, DateTimeKind.Utc).AddTicks(931),
                            Description = "Chưa Xóa Thông Báo"
                        },
                        new
                        {
                            IdDeleteNotification = 2,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 332, DateTimeKind.Utc).AddTicks(1163),
            ...
            modelBuilder.Entity("DataTable.Table.User.T_LeverUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdLever = 1,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 332, DateTimeKind.Utc).AddTicks(2217),
                        ...
                        {
                            IdLever = 2,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 332, DateTimeKind.Utc).AddTicks(2464),
                        ...
                        {
                            IdLever = 3,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 332, DateTimeKind.Utc).AddTicks(2467),
            ...
            modelBuilder.Entity("DataTable.Table.User.T_StaffOrUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdStaffOrUser = 1,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 332, DateTimeKind.Utc).AddTicks(3490),
                            Description = "Người Dùng",
                            Status = true,
                            symbol = "ND"
                        },
                        ...
                        {
                            IdStaffOrUser = 2,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 332, DateTimeKind.Utc).AddTicks(3923),
                            Description = "Nhân Viên",
                            Status = true,
                            symbol = "NV"
                        });
            ...
            modelBuilder.Entity("DataTable.Table.User.T_ViewNotification", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 332, DateTimeKind.Utc).AddTicks(4670),
                            Description = "Đã Xem"
                        },
                        new
                        {
                            IdViewNotification = 2,
                            DateCreate = new DateTime(2022, 8, 11, 10, 58, 40, 332, DateTimeKind.Utc).AddTicks(4902),
